...
using OpenCvSharp;
using System.Data;
using Img2table.Sharp.Tabular.Processing;
using Img2table.Sharp.Tabular.TableElement;
using Img2table.Sharp.Tabular.Processing.BorderlessTables.Layout;
...
namespace Img2table.Sharp.Tabular.Processing.BorderlessTables
{
    public class BorderlessTableIdentifier
    {
        ...
        {
            var tableSegments = Layout.ImageLayout.SegmentImage(thresh, lines, char_length, medianLineSep, existingTables);

...
using Img2table.Sharp.Core.Tables.Processing.BorderlessTables.layout;
using Img2table.Sharp.Core.Tables.Processing.BorderlessTables.Table;
using OpenCvSharp;
using System.Data;
using static Img2table.Sharp.Core.Tables.Objects.Objects;

namespace Img2table.Sharp.Core.Tables.Processing.BorderlessTables
{

...
using Img2table.Sharp.Core.Tables.Processing.BorderedTables;
using Img2table.Sharp.Core.Tables.Processing.BorderedTables.Cells;
using Img2table.Sharp.Core.Tables.Processing.BorderedTables.Tables;
using Img2table.Sharp.Core.Tables.Processing.BorderlessTables;
using OpenCvSharp;
using OpenCvSharp.XImgProc;
using static Img2table.Sharp.Core.Tables.Objects.Objects;

namespace Img2table.Sharp.Core.Tables
{
    public class TableImage
    {
        ...
        private void ExtractBorderedTables(bool implicitRows = false, bool implicitColumns = false)
        {
            ...
            _tables = Processing.BorderedTables.Tables.Tables.GetTables(cells, _contours, _lines, _charLength);

...
namespace Img2table.Sharp.Core.Tabular.Processing.BorderlessTables.layout
{
    public class RLSA
    {
        public static Mat IdentifyTextMask(Mat thresh, List<Line> lines, double charLength, List<Object.Table> existing_tables = null)
        {
            ...
            foreach (var tb in existing_tables ?? new List<Object.Table>())
            {
